...
export default async function BlogPost({ params }: { params: { slug: string } }) {
    ...
    const options = {
        renderNode: {
            ...
            'heading-1': (node: any, children: any) => <h1 className="text-4xl font-normal my-6">{children}</h1>,
            'heading-2': (node: any, children: any) => <h2 className="text-3xl font-normal my-5">{children}</h2>,
            'heading-3': (node: any, children: any) => <h3 className="text-2xl font-normal   my-4">{children}</h3>,
